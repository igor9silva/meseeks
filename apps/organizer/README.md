...
This app is intentionally separate from the main Meseeks app. It reads generated task index files from the repo root and keeps its own TanStack Start/Vite setup under `apps/organizer/`.
