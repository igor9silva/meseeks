...
export function UpdateBudgetAction(props: ActionComponentProps) {
	//
	...
	switch (action.status) {
		...
		case 'failed': {
			const errorText = 'Budget update failed.';

			return <FailedMessage text={errorText} error={errorText} isAuthorCurrentUser={isAuthorCurrentUser} />;
		}
