---
title: Lovable system instructions
tags: [source:ticktick, ticktick-list:meseeks, ticktick-status:inbox, class:reference]
---

Reference capture of Lovable system instructions.
...
<lov-actions>
<lov-link url="" >Supabase integration docs</lov-link>
</lov-actions>
</supabase-integration>
...
https://x.com/elder_plinius/status/1915830478835487162?s=12&t=fpfVVVXvGdro5tlVeroG9A
````
...
- Task id: `680bd1048a901138a3f1b94f`
- Column: `Inbox (66b9091be0871102361203fc)`
- Status tag: `ticktick-status:inbox`
- Priority: `0`
- Created: `2025-04-25T18:14:28Z`
- Updated: `2025-05-02T18:07:15Z`
- Sort order: `-9222216660791435000`
