---
title: "Failed to persist initial actions"
tags: [legacy, source:ticktick, ticktick-list:meseeks, ticktick-status:inbox, status:backlog]
---
...
![image](attachments/d07a80ed-a1a17cd5-dfb1-44b2-a03c-b40904ac7326.png)
...
```json
{
  ...
  "tickTick": {
    ...
    "columnName": "Inbox",
    "title": "Fix THAT",
    "content": "![image](attachments/d07a80ed-a1a17cd5-dfb1-44b2-a03c-b40904ac7326.png)\n",
    "description": "",
    "notionBlockString": "",
    "status": 0,
    "deletionStatus": 0,
