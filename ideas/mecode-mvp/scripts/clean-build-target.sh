...
case "$build_environment" in
	dev)
		app_bundle="$project_root/build/$build_environment-macos-$build_arch/Mecode MVP-dev.app"
		;;
	stable)
		app_bundle="$project_root/build/$build_environment-macos-$build_arch/Mecode MVP.app"
		;;
esac
