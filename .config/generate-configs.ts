 ...
 *   - .codex/environments/environment.toml (for Codex app environments)
...
function generateCodexEnvironmentsConfig(): void {
	...
	const codexEnvironmentsPath = path.join(codexEnvironmentsDir, 'environment.toml');
	const environmentsContent = `# THIS IS AUTOGENERATED. DO NOT EDIT MANUALLY
version = 1
name = "meseeks"

[setup]
script = "bun run config:build"
