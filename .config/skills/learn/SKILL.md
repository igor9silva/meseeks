...
Review the full conversation, identify every place where the user corrected the model, and update `.config/rules.md` and `.config/skills/` so the same mistakes never happen again.
