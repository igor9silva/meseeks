...
- Self-contained `macos-app/` package with its own `package.json`
...
- Repository isolation: all changes are under `macos-app/`
...
1. Run `cd macos-app && bun install && bun run dev`
